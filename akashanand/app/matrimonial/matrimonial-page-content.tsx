...
function Chip({ children }: { children: ReactNode }) {
  return (
    <span className="rounded-full border border-[#eadfd4] bg-[#fffaf5] px-3 py-2 text-sm font-semibold text-[#47362e] shadow-[0_6px_18px_rgba(86,59,42,0.05)]">
      {children}
    </span>
  );
}
...
export function MatrimonialPageContent({ locale }: { locale: MatrimonialLocale }) {
  ...
  return (
    ...
    >
      <header className="sticky top-0 z-50 border-b border-[#eadfd4]/80 bg-[#fffdf9]/92 shadow-[0_8px_30px_rgba(86,59,42,0.06)] backdrop-blur-xl supports-[backdrop-filter]:bg-[#fffdf9]/88">
        <div className="mx-auto flex max-w-6xl min-w-0 flex-col gap-3 px-3 py-2.5 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-x-3 sm:gap-y-2 sm:px-4 sm:py-3 md:px-6 lg:px-8">
      ...
      <div className="mx-auto min-w-0 max-w-6xl px-3 py-5 sm:px-4 sm:py-7 md:px-6 md:py-8 lg:px-8 lg:py-9">
        <section className="grid min-w-0 gap-5 sm:gap-6 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-start lg:gap-8">
          <div id="photos" className="order-1 min-w-0 scroll-mt-[4.5rem] sm:scroll-mt-24 lg:order-2">
          ...
          <Reveal className="order-2 min-w-0 lg:order-1">
            <div className="rounded-2xl border border-[#e9dccf]/80 bg-[linear-gradient(145deg,#fffdf9,#fff6ea)] p-4 shadow-[0_28px_90px_rgba(86,59,42,0.12)] sm:rounded-[2rem] sm:p-6 md:p-8 lg:rounded-[2.25rem] lg:p-10">
              ...
              <p className="mt-2 text-pretty text-base font-medium leading-snug text-[#5e4436] sm:mt-3 sm:text-lg">
                {profile.coreDetails[0].value} · {profile.coreDetails[1].value} ·{" "}
                {profile.coreDetails[2].value} · {profile.coreDetails[3].value}
              </p>
              <p className="mt-2 text-pretty text-xs leading-relaxed text-[#715c51] sm:text-sm">
              ...
              <p className="mt-2 text-pretty text-sm leading-relaxed text-[#715c51] sm:text-base">
                {profile.headline}
              </p>
              ...
              <div className="mt-5 grid grid-cols-1 gap-2.5 min-[480px]:grid-cols-2 sm:mt-7 sm:flex sm:flex-wrap sm:gap-3">
                <a
                  href={`mailto:${profile.contactEmail}`}
                  className="inline-flex min-h-12 w-full items-center justify-center rounded-full bg-[#76513c] px-4 py-3.5 text-center text-sm font-semibold text-white shadow-sm transition hover:bg-[#5f3f2e] sm:w-auto sm:min-w-[10rem] sm:px-5"
                >
                  {ui.connectEmail}
                </a>
                <a
                  ...
                  className="inline-flex min-h-12 w-full items-center justify-center rounded-full border border-[#d8c7b9] bg-[#fff8ef] px-4 py-3.5 text-center text-sm font-semibold text-[#5e4436] transition hover:border-[#9b6a4d] hover:bg-white sm:w-auto sm:min-w-[10rem] sm:px-5"
                >
                  {ui.downloadBiodata}
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex min-h-12 w-full items-center justify-center rounded-full border border-[#cddfde] bg-[#f7fbfb] px-4 py-3.5 text-center text-sm font-semibold text-[#2f6e68] transition hover:border-[#4b8f86] hover:bg-white sm:w-auto sm:min-w-[10rem] sm:px-5"
                >
                  {ui.linkedInProfile}
                </a>
                <a
                  href="#photos"
                  className="inline-flex min-h-12 w-full items-center justify-center rounded-full border border-[#d8c7b9] bg-white px-4 py-3.5 text-center text-sm font-semibold text-[#5e4436] transition hover:border-[#9b6a4d] hover:bg-[#fff8ef] sm:w-auto sm:min-w-[10rem] sm:px-5"
                >
                  {ui.viewPhotos}
                </a>
              </div>
        ...
        <Reveal>
          <section className="mt-6 overflow-hidden rounded-2xl border border-[#d8c7b9]/80 bg-[linear-gradient(135deg,#3a2a22,#76513c_52%,#4b8f86)] p-4 text-white shadow-[0_30px_90px_rgba(86,59,42,0.2)] sm:mt-8 sm:rounded-[2rem] sm:p-6 md:p-8">
            <div className="grid min-w-0 gap-6 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-8">
              <div className="min-w-0">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[#f8e8dc] sm:mt-4 sm:leading-7">{ui.footerBody}</p>
              </div>
              <div className="grid min-w-0 grid-cols-1 gap-2.5 min-[420px]:grid-cols-2 lg:flex lg:max-w-sm lg:flex-col lg:gap-3">
                <a
                  href={`mailto:${profile.contactEmail}`}
                  className="inline-flex min-h-12 w-full items-center justify-center break-all rounded-full bg-white px-4 py-3.5 text-center text-xs font-semibold text-[#5f3f2e] shadow-sm transition hover:-translate-y-0.5 hover:bg-[#fff8ef] sm:text-sm"
                >
                ...
                <a
                  href={profile.biodataUrl}
                  download="akash-anand-biodata.pdf"
                  className="inline-flex min-h-12 w-full items-center justify-center rounded-full border border-white/28 bg-white/10 px-4 py-3.5 text-sm font-semibold text-white backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/18"
                >
                  {ui.downloadBiodata}
                </a>
                <a
