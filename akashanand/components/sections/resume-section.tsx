...
export function ResumeSection() {
  return (
    <SectionShell id="resume">
      <div className="rounded-[2rem] border border-[var(--color-border)] bg-[linear-gradient(180deg,var(--color-surface),var(--color-surface-muted))] p-8 shadow-[var(--shadow-soft)] sm:p-10">
        <SectionHeading
          eyebrow="Resume"
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row">
          <Link
            href="/resume"
            className="inline-flex items-center justify-center rounded-full bg-[var(--color-accent)] px-5 py-3 text-sm font-semibold text-white transition-transform duration-200 hover:-translate-y-0.5"
          >
            Open resume page
          </Link>
          <a
